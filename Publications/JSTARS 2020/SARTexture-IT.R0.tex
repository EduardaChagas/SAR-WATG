...
Section\~ref{Methods} we summarize the weighted ordinal patterns methods used to compare with our proposal, and the description of the SAR image datasets used in this work.
Section~\ref{Results} presents 
