...
\begin{document}
	...
	\begin{table*}[hbt]
		...
		\begin{tabular}{l*9{r}}
			...
			STFT + SURF  & 1856 & 0.000 & 0.000  & 0.916 & 0.000 & 0.000  & 0.478 & 0.458 & 0.000\\ %\cmidrule(rl){1-10}
			\cmidrule(lr){1-1}
			\cmidrule(lr){2-2}
			\cmidrule(lr){3-5}
			\cmidrule(lr){6-8}
			...
			Transition Graph & 2  & 1.000 & 0.666  & 1.000 & 0.857 & 1.000  & 0.923 & 0.916 & 0.800 \\ %\cmidrule(rl){1-10}
			\cmidrule(lr){1-1}
			\cmidrule(lr){2-2}
			\cmidrule(lr){3-5}
			\cmidrule(lr){6-8}
			...
			AAPE   & 2 & 0.833 &  0.833  & 0.916 & 1.000 & 0.714  & 0.916 & 0.875 &  0.769\\ %\cmidrule(rl){1-10}
			\cmidrule(lr){1-1}
			\cmidrule(lr){2-2}
			\cmidrule(lr){3-5}
			\cmidrule(lr){6-8}
