...
and~Heitor~S.~Ramos \orcidicon{0000-0003-4523-6466},\IEEEmembership{IEEE~Senior~Member}
	...
	\thanks{A.\ C.\ Frery is with the School of Mathematics and Statistics, Victoria University of Wellington, 6140 New Zealand; (e-mail: \mbox{alejandro.frery@vuw.ac.nz})}
...
\begin{abstract}
	...
	This modification considers the unfavorable signal-to-noise ratio of the target and leads to the characterization of several types of textures.
...
\begin{figure}
	\centering
	\subfigure[$z$]{\label{Fig:TestZ}\includegraphics[width = 28mm]{Figures/Z.pdf}}
...
\begin{figure*}%[!htb]
	...
	\subfigure[Sea -- lower contrast\label{Fig:figCape1}]{\includegraphics[width = 35mm]{Figures/Cape12.pdf}}
	...
	\subfigure[Signal -- sea\label{Fig:TSCape1}]{\includegraphics[width = 35mm]{Figures/tscape12.pdf}}
	\subfigure[Signal -- sea\label{Fig:TSCape2}]{\includegraphics[width = 35mm]{Figures/tscape2.pdf}}
	\subfigure[Signal -- urban\label{Fig:TSMunich}]{\includegraphics[width = 35mm]{Figures/tsmunich.pdf}}
	...
	\caption{Types of regions (Guatemala forest, Canaveral ocean types 1 and 2, Munich urban area, and pasture area), their signal representation, and histograms.}
...
\begin{IEEEbiography}[{\includegraphics[width=1.6in,height=1in,clip,keepaspectratio]{Figures/duda.jpg}}]{Eduarda T. C. Chagas} is a Master's student in Computer Science at Federal University of Minas Gerais since 2019. 
