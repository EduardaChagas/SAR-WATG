...
\begin{document}
	...
	\author{Eduarda~T.~C.~Chagas \orcidicon{0000-0001-9647-0506},
		Alejandro~C.~Frery \orcidicon{0000-0002-8002-5341}, \IEEEmembership{IEEE~Senior~Member,}
	...
	\begin{abstract}
		...
		This modification considers the \DIFdelbegin \DIFdel{scattering properties }\DIFdelend \DIFaddbegin \DIFadd{unfavorable signal-to-noise ratio }\DIFaddend of the target and leads to the characterization of several types of textures.
	...
	\DIFaddbegin \DIFadd{In any case, speckle produces low signal-to-noise ratio images.
	}\DIFaddend 
	...
	$W(L) \sim \Gamma(L, L)$,
	with \DIFdelbegin \DIFdel{$L \in \{1, 100, 150, 200, 250, 300, 350, 400, 450, 500\}$}\DIFdelend \DIFaddbegin \DIFadd{$L \in \{1, 5, 10, 15, \dots, 45, 50\}$}\DIFaddend .
	The observed images $I(L)$ are the pixelwise product of $z$ and $w(L)$.
	Fig.~\ref{Fig:TestZW} shows the product \DIFdelbegin \DIFdel{$I(100)$}\DIFdelend \DIFaddbegin \DIFadd{$I(1)$}\DIFaddend .
	
	\begin{figure}
		\centering
		\DIFdelbeginFL %DIFDELCMD < \subfigure[$z$]{\label{Fig:TestZ}\includegraphics[width = 28mm]{Figures/z.png}}
		%DIFDELCMD < 	\subfigure[$I(100)$]{\label{Fig:TestZW}\includegraphics[width = 28mm]{Figures/z100.png}}
		%DIFDELCMD < 	\subfigure[$I^{\text{T}}(500)$]{\label{Fig:TestRot}\includegraphics[width = 28mm]{Figures/z500t.png}}
		%DIFDELCMD < 	%%%
		\DIFdelendFL \DIFaddbeginFL \subfigure[$z$]{\label{Fig:TestZ}\includegraphics[width = 28mm]{Figures/Z.pdf}}
		\subfigure[$I(1)$]{\label{Fig:TestZW}\includegraphics[width = 28mm]{Figures/Z1.pdf}}
		\subfigure[$I^{\text{T}}(1)$]{\label{Fig:TestRot}\includegraphics[width = 28mm]{Figures/Z1t.pdf}}
		\DIFaddendFL \caption{Ground truth, speckled, and speckled transposed versions.}
		\label{Fig:TestZWL}
	\end{figure}
	...
	\DIFaddbegin \DIFadd{We applied equalization to the patches to improve their visualization.
	...
	}\DIFaddend In our analysis, both types of ocean images are grouped.
	...
	\begin{figure*}%DIF > [!htb]
		...
		\DIFdelbeginFL %DIFDELCMD < \subfigure[Sea -- lower contrast\label{Fig:figCape1}]{\includegraphics[width = 35mm]{Figures/Cape1.pdf}}
		%DIFDELCMD < 	%%%
		\DIFdelendFL \DIFaddbeginFL \subfigure[Sea -- lower contrast\label{Fig:figCape1}]{\includegraphics[width = 35mm]{Figures/Cape12.pdf}}
		\DIFaddendFL \subfigure[Sea -- higher contrast\label{Fig:figCape2}]{\includegraphics[width = 35mm]{Figures/Cape2.pdf}}
		...
		\DIFdelbeginFL %DIFDELCMD < \subfigure[Signal -- sea\label{Fig:TSCape1}]{\includegraphics[width = 35mm]{Figures/tscape1.pdf}}
		%DIFDELCMD < 	%%%
		\DIFdelendFL \DIFaddbeginFL \subfigure[Signal -- sea\label{Fig:TSCape1}]{\includegraphics[width = 35mm]{Figures/tscape12.pdf}}
		\DIFaddendFL \subfigure[Signal -- sea\label{Fig:TSCape2}]{\includegraphics[width = 35mm]{Figures/tscape2.pdf}}
		\DIFdelbeginFL %DIFDELCMD < \subfigure[Signal -- sea\label{Fig:TSMunich}]{\includegraphics[width = 35mm]{Figures/tsmunich.pdf}}
		%DIFDELCMD < 	%%%
		\DIFdelendFL \DIFaddbeginFL \subfigure[Signal -- urban\label{Fig:TSMunich}]{\includegraphics[width = 35mm]{Figures/tsmunich.pdf}}
		\DIFaddendFL \subfigure[Signal -- pasture\label{Fig:TSPasture}]{\includegraphics[width = 35mm]{Figures/tspasture.pdf}}
		\DIFaddbeginFL 
		
		\subfigure[Histogram -- forest\label{Fig:HistGuatemala}]{\includegraphics[width = 35mm]{Figures/guatemala-hist.pdf}}
		\subfigure[Histogram -- sea\label{Fig:HistCape1}]{\includegraphics[width = 35mm]{Figures/cape1-hist.pdf}}
		\subfigure[Histogram -- sea\label{Fig:HistCape2}]{\includegraphics[width = 35mm]{Figures/cape2-hist.pdf}}
		\subfigure[Histogram -- urban\label{Fig:HistMunich}]{\includegraphics[width = 35mm]{Figures/munich-hist.pdf}}
		\subfigure[Histogram -- pasture\label{Fig:HistPasture}]{\includegraphics[width = 35mm]{Figures/pasture-hist.pdf}}
		\DIFaddendFL \caption{Types of regions (Guatemala forest, Canaveral ocean types 1 and 2, Munich urban area, and pasture area)\DIFdelbeginFL \DIFdelFL{and }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, }\DIFaddendFL their signal representation\DIFaddbeginFL \DIFaddFL{, and histograms}\DIFaddendFL .}
	...
	Fig.~\ref{fig:samples&Series} shows examples of the ocean, forest, urban, and pasture both as image patches and as 1-D sequences after the linearization process\DIFaddbegin \DIFadd{:
		the first row shows the equalized patches,
		the second row presents the original data as a signal,
		and the third row shows the histograms of the original data after scaling with~}\eqref{eq:scaling}\DIFaddend .
	...
	\begin{IEEEbiography}[{\includegraphics[width=1.6in,height=1in,clip,keepaspectratio]{Figures/duda.jpg}}]{Eduarda T. C. Chagas} \DIFadd{is a Master's student in Computer Science at Federal University of Minas Gerais since 2019. 
	...
	\begin{IEEEbiography}[{\includegraphics[width=1.2in,height=1.2in,clip,keepaspectratio]{Figures/alejandro.jpeg}}] {\DIFadd{Alejandro C. Frery}} \DIFadd{(Senior Member, IEEE) received the B.Sc. degree in electronic and electrical engineering from the Universidad de Mendoza, Mendoza, Argentina, in 1985, the M.Sc. degree in applied mathematics (statistics) from the Instituto de Matemática Pura e Aplicada, Rio de Janeiro, Brazil, in 1990, and the Ph.D. degree in applied computing from the Instituto Nacional de Pesquisas Espaciais, São José dos Campos, Brazil, in 1993.
